...
[GameEventName("player_team")]
internal partial class EventPlayerTeam : GameEvent, IEventPlayerTeam
{
    ...
    [GameEventProperty("newteam")]
    private CStrikeTeam? _newTeam;

    [GameEventProperty("oldteam")]
    private CStrikeTeam? _oldTeam;
